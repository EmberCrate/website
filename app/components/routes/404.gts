  ...
  <section class='bg-white'>
    <div class='mx-auto max-w-screen-xl py-8 px-4 lg:py-16 lg:px-6'>
      <div class='mx-auto max-w-screen-sm text-center'>
        ...
        <LinkTo
          @route='application'
          class='my-4 inline-flex rounded-lg bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300'
        >
          Back to Homepage
        </LinkTo>
      </div>
